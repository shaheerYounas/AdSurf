...
| Section | Purpose |
| --- | --- |
| Products | Product profiles and defaults. |
| Uploads | Research files, mapping status, parse issues. |
| Keywords | Scores, rejection reasons, approval controls. |
| Campaign Plans | Hero, groups, match types, negatives, budgets, bids. |
| Bulk Exports | Export status, validation, approval, download. |
